// gallery.js — renders the editorial Gallery scene from data/gallery.js (window.KGM_GALLERY).
  ...
  function renderGallery(data) {
    ...
    grid.querySelectorAll('[data-gallery-id]').forEach((el) => {
      el.addEventListener('click', () => {
        window.KGM.analytics.track('gallery_interact', { method: 'open', item: el.dataset.galleryId });
      }, { passive: true });
    });
  }

  window.KGM.gallery = { renderGallery };
})();
