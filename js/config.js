// KGM UAE Microsite — central configuration.
...
window.KGM.CONFIG = {
  ...
  // CONTENT REQUIRED — brief §13 item 8 (form submission endpoint / provider)
  SUBMIT_ENDPOINT: null,

  // CONTENT REQUIRED — brief §13 item 13
  GA4_MEASUREMENT_ID: null,

  // Decision required — visual-ux Appendix A #3 (map provider)
  MAP_PROVIDER: null, // "embed" | "static" | null
